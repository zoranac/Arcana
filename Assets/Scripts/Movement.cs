...
public class Movement : MonoBehaviour {
	...
	void Update () {
		...
		Vector2 stickInput = new Vector2(inputDevice.LeftStickX, inputDevice.LeftStickY);
		//Deadzone calc
		...
		//if (this.rigidbody2D.velocity.magnitude < 100f) {
		//		this.rigidbody2D.AddForce (movement * moveSpeed);
		//}
